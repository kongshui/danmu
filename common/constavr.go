...
const (
	...
	RoomId_Register_Uid_key    = "/roomid_register_key/"        // roomId注册，roomId和client Uuid信息
	Uid_Register_RoomId_key    = "/roomid_register_key/"        // roomId注册，roomId和client Uuid信息
	GroupId_Register_key       = "/groupid_register_key/"       // groupId注册，注册groupId和client Uuid
	UserId_Register_Uid_key    = "/userid_register_key/"        // userId注册，注册userId和client Uuid
	Uid_Register_UserId_key    = "/userid_register_key/"        // userId注册，注册userId和client Uuid
	OpenId_Register_Uid_key    = "/openid_register_key/"        // openId注册，注册openId和client Uuid
	Uid_Register_OpenId_key    = "/openid_register_key/"        // openId注册，注册openId和client Uuid
